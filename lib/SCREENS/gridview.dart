            ...
            actions: [
              TextButton(
                  style: TextButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 236, 51, 51)),
                  onPressed: () async {
                    snack(context);
              ...
              TextButton(
                  style: TextButton.styleFrom(
                      backgroundColor: Color.fromARGB(255, 94, 233, 63)),
                  onPressed: () {
                    Navigator.of(context).pop();
                  },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromRGBO(32, 129, 185, 1),
        ),
        body: Column(
          children: [
            SizedBox(
                ...
                builder: (context, AsyncSnapshot<List<USer>> user) {
                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        color: const Color.fromARGB(255, 32, 129, 185),
